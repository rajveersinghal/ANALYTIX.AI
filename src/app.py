...
import pandas as pd
import traceback
from src.core import data_loader, data_quality, cleaning, eda, features, modeling, insights, data_validator, metrics, utils
...
# --- Intelligence Layer ---
from src.intelligence import dashboard, experiment_tracker, explainability, alerts, recommendations, report_generator
...
with tab_monitor:
    from src.intelligence import monitoring
    # Load history
